...
export default function ModeToggle({ mode, onToggle }: Props) {
  return (
    <div
      className="inline-flex items-center bg-[#161616] border border-[#242428] p-1 text-[12px] tracking-[0.14em] font-medium select-none"
    ...
    >
      <button
        ...
        className={
          mode === "gui"
            ? "inline-flex min-h-9 items-center justify-center px-4 py-2 leading-none text-[#0a0a0b] transition-colors duration-150"
